    ...
    private class BackTask extends AsyncTask<String,Integer,Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                LinearLayout layout1 = (LinearLayout) getView().findViewById(R.id.three1);
                LinearLayout layout2 = (LinearLayout) getView().findViewById(R.id.three2);
                LinearLayout layout3 = (LinearLayout) getView().findViewById(R.id.three3);
                ...
                for(int i=0;i<jArray.length(); i++) {
                    ...
                    if(day==3) {
                        if (stage == 1) {
                            stage1 = (TextView) getView().findViewById(R.id.stage13);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            stage2 = (TextView) getView().findViewById(R.id.stage23);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            stage3 = (TextView) getView().findViewById(R.id.stage33);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
