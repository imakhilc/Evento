    ...
    private class BackTask extends AsyncTask<String,Integer,Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                LinearLayout layout1 = (LinearLayout) getView().findViewById(R.id.one1);
                LinearLayout layout2 = (LinearLayout) getView().findViewById(R.id.one2);
                LinearLayout layout3 = (LinearLayout) getView().findViewById(R.id.one3);
                ...
                for(int i=0;i<jArray.length(); i++) {
                    ...
                    if(day==1) {
                        if (stage == 1) {
                            stage1 = (TextView) getView().findViewById(R.id.stage11);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            stage2 = (TextView) getView().findViewById(R.id.stage21);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            stage3 = (TextView) getView().findViewById(R.id.stage31);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
